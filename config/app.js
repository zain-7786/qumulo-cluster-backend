...
module.exports = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Always load these files on boot
  |
  */
  autoload: {
    app: './app',
  ...
  |--------------------------------------------------------------------------
  |
  | The providers are loaded on demand based on your request.
  |
  */
  providers: [
    '@adonisjs/framework/providers/AppProvider',
    '@adonisjs/framework/providers/ConfigProvider',
    '@adonisjs/framework/providers/EventProvider',
    '@adonisjs/framework/providers/ExceptionProvider',
    '@adonisjs/framework/providers/HelpersProvider',
    '@adonisjs/framework/providers/HttpProvider',
    '@adonisjs/framework/providers/LoggerProvider',
    '@adonisjs/framework/providers/ViewProvider',
    '@adonisjs/lucid/providers/LucidProvider', // <-- This line is crucial
    '@adonisjs/auth/providers/AuthProvider',
    'Adonis/Providers/Lucid'
  ],
  /*
  |--------------------------------------------------------------------------
  | Aliases
  |--------------------------------------------------------------------------
  |
  | List of aliases that can be used in your app code.
  |
  */
  aliases: {},
  ...
  |--------------------------------------------------------------------------
  |
  | For running ace commands on the terminal
  |
  */
  aceCommands: [],
